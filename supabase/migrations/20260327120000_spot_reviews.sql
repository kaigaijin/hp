...
create index if not exists idx_place_reviews_place
  on place_reviews (place_country, place_category, place_slug);
create index if not exists idx_place_reviews_reviewer
  on place_reviews (reviewer_id);
...
create or replace view place_review_summary as
select
  place_country,
  place_category,
  place_slug,
...
from place_reviews
group by place_country, place_category, place_slug;
